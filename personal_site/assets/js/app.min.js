"use strict";!function(e){if(e(document).on("click",".nav a, .mobile-nav a",(function(a){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var o=this.hash;if(e(o).length)return a.preventDefault(),e(this).parents(".nav, .mobile-nav").length&&(e(".nav .active, .mobile-nav .active").removeClass("active"),e(this).closest("li").addClass("active")),"#header"==o?(e("#header").removeClass("header-top"),void e("section").removeClass("section-show")):(e("#header").hasClass("header-top")?(e("section").removeClass("section-show"),e(o).addClass("section-show")):(e("#header").addClass("header-top"),setTimeout((function(){e("section").removeClass("section-show"),e(o).addClass("section-show")}),350)),e("html, body").animate({scrollTop:0},350),e("body").hasClass("mobile-nav-active")&&(e("body").removeClass("mobile-nav-active"),e(".mobile-nav-toggle i").toggleClass("icofont-navigation-menu icofont-close"),e(".mobile-nav-overly").fadeOut()),!1)}})),window.location.hash){var a=window.location.hash;e(a).length&&(e("#header").addClass("header-top"),e(".nav .active, .mobile-nav .active").removeClass("active"),e(".nav, .mobile-nav").find('a[href="'+a+'"]').parent("li").addClass("active"),setTimeout((function(){e("section").removeClass("section-show"),e(a).addClass("section-show")}),350))}e(document).ready((function(){e(".venobox").venobox({share:!1})}))}(jQuery);
