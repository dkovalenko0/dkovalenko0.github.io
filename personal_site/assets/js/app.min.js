"use strict";!function(e){if(e(document).on("click",".nav a, .mobile-nav a",(function(o){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var a=this.hash;if(e(a).length)return o.preventDefault(),e(this).parents(".nav, .mobile-nav").length&&(e(".nav .active, .mobile-nav .active").removeClass("active"),e(this).closest("li").addClass("active")),"#header"==a?(e("#header").removeClass("header-top"),void e("section").removeClass("section-show")):(e("#header").hasClass("header-top")?(e("section").removeClass("section-show"),e(a).addClass("section-show")):(e("#header").addClass("header-top"),setTimeout((function(){e("section").removeClass("section-show"),e(a).addClass("section-show")}),350)),e("html, body").animate({scrollTop:0},350),e("body").hasClass("mobile-nav-active")&&(e("body").removeClass("mobile-nav-active"),e(".mobile-nav-toggle i").toggleClass("icofont-navigation-menu icofont-close"),e(".mobile-nav-overly").fadeOut()),!1)}})),window.location.hash){var o=window.location.hash;e(o).length&&(e("#header").addClass("header-top"),e(".nav .active, .mobile-nav .active").removeClass("active"),e(".nav, .mobile-nav").find('a[href="'+o+'"]').parent("li").addClass("active"),setTimeout((function(){e("section").removeClass("section-show"),e(o).addClass("section-show")}),350))}if(e(".nav").length){var a=e(".nav").clone().prop({class:"mobile-nav d-lg-none"});e("body").append(a),e("body").prepend('<div class="menu mobile-nav-toggle"><div></div><div></div><div></div></div>'),e("body").append('<div class="mobile-nav-overly"></div>'),e(document).on("click",".mobile-nav-toggle",(function(o){e("body").toggleClass("mobile-nav-active"),e(".mobile-nav-toggle i").toggleClass("icofont-navigation-menu icofont-close"),e(".mobile-nav-overly").toggle()})),e(document).click((function(o){var a=e(".mobile-nav, .mobile-nav-toggle");a.is(o.target)||0!==a.has(o.target).length||e("body").hasClass("mobile-nav-active")&&(e("body").removeClass("mobile-nav-active"),e(".mobile-nav-toggle i").toggleClass("icofont-navigation-menu icofont-close"),e(".mobile-nav-overly").fadeOut())}))}else e(".mobile-nav, .mobile-nav-toggle").length&&e(".mobile-nav, .mobile-nav-toggle").hide();e(document).ready((function(){e(".venobox").venobox({share:!1,bgcolor:"rgba(0, 0, 0, 0.8)"})}))}(jQuery);
