!function(s){"use strict";s(".slider").slick({dots:!0,infinite:!0,slidesToShow:1,slidesToScroll:1,nextArrow:'<img src="assets/images/slider-arrow.svg" class="arrows next-arrow"></img>',prevArrow:'<img src="assets/images/slider-arrow.svg" class="arrows prev-arrow"></img>'}),s(".nav-toogler").click((function(r){s(".nav-toogler, .nav-menu").toggleClass("active"),s("body").toggleClass("lock")}))}(jQuery);
